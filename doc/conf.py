...
# -*- coding: utf-8 -*-
#
# DXfile documentation build configuration file, created by
...
Affiliation = u'Lorentz Workshop: Quantitative 3D X-Ray Imaging'
project = u'The Lorentz Phantom'
